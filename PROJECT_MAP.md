...
| `data/site_data/` | JSON contract consumed by the frontend | Active output, do not delete |
...
- Do not delete `models/v12/`, `data/site_data/`, schema files, backups, or diagnostic artifacts just because they are large or old.
