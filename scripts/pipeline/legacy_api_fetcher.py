...
Usage:
    ...
    python scripts/pipeline/fetch_openaq.py --country US --days 7
    python scripts/pipeline/fetch_openaq.py --country GB --days 30
    python scripts/pipeline/fetch_openaq.py --country CN              # full backfill
    python scripts/pipeline/fetch_openaq.py --country IN --days 7     # India incremental
"""
