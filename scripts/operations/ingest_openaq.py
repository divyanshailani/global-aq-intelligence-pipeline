...
Usage:
    ...
    python scripts/operations/ingest_openaq.py                      # full backfill
    python scripts/operations/ingest_openaq.py --days 7              # last 7 days only
    python scripts/operations/ingest_openaq.py --station-id 17       # single station
"""
