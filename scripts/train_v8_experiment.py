...
MODEL_DIR = os.path.join(os.path.dirname(__file__), "..", "models", "v8")
...
def train_horizon_model(conn, country_code, horizon):
    ...
    # Calculate Naive MAE and MASE for backtest
    # Naive guess for h is exactly the lag_col!
